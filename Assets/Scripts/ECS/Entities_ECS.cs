...
public class Entities_ECS : MonoBehaviour
{
    ...
    static Entities_ECS instance = null;

    public static Entities_ECS Instance
    {
        get
        {
            if (instance == null)
                instance = FindObjectOfType<Entities_ECS>();
    ...
    void Start()
    {
        ...
        for (int i = 0; i < entityCount; i++)
        {
            ...
            ECSManager.AddComponent<NeuralComponent>(entityID, new NeuralComponent(brains));
    ...
    void LateUpdate()
    {
        ...
        {
            neuronComponent = ECSManager.GetComponent<NeuronComponent>(entities[i]);
            layerComponent = ECSManager.GetComponent<LayerComponent>(entities[i]);
            neuralComponent = ECSManager.GetComponent<NeuralComponent>(entities[i]);
    ...
    void GenerateInitialPopulation()
    {
        ...
        {
            NeuralNetwork brain = CreateBrain(neuralComponent.brains[i]);
    ...
    NeuralNetwork CreateBrain(NeuralNetwork brain)
    {
